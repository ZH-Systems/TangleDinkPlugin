...
import tccrewplugin.ClanEventOverlay;
import tccrewplugin.TcCrewPlugin;
import tccrewplugin.DinkPluginConfig;
import tccrewplugin.MockedTestBase;
...
import tccrewplugin.util.BlockingClientThread;
import tccrewplugin.util.BlockingExecutor;
import tccrewplugin.util.IndexedArray;
...
abstract class MockedNotifierTest extends MockedTestBase {
    ...
    @Bind
    protected TcCrewPlugin plugin = Mockito.spy(TcCrewPlugin.class);
