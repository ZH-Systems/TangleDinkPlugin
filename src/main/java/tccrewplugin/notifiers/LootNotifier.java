...
import tccrewplugin.domain.LootCriteria;
import tccrewplugin.message.Embed;
import tccrewplugin.message.NotificationBody;
import tccrewplugin.message.NotificationType;
import tccrewplugin.message.templating.Evaluable;
import tccrewplugin.message.templating.Replacements;
import tccrewplugin.message.templating.Template;
import tccrewplugin.message.templating.impl.JoiningReplacement;
import tccrewplugin.notifiers.data.AnnotatedItemStack;
import tccrewplugin.notifiers.data.LootNotificationData;
import tccrewplugin.notifiers.data.RareItemStack;
import tccrewplugin.notifiers.data.SerializedItemStack;
import tccrewplugin.util.ConfigUtil;
import tccrewplugin.util.ItemUtils;
import tccrewplugin.util.KillCountService;
import tccrewplugin.util.MathUtils;
import tccrewplugin.util.ThievingService;
import tccrewplugin.util.RarityService;
