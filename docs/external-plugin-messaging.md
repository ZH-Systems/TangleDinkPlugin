...
The `Map<String, Object>` that is supplied to `PluginMessage` will be converted into [`ExternalNotificationRequest`](../src/main/java/TcCrewPlugin/domain/ExternalNotificationRequest.java).
