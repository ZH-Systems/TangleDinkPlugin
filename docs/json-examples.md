...
The possible values for `extra.items[].criteria` correspond to our [`LootCriteria`](https://github.com/pajlads/DinkPlugin/blob/master/src/main/java/TcCrewPlugin/domain/LootCriteria.java) enum.
